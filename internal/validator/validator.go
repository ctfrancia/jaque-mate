...
// Validator defines the obj of what's inside
...
// Valid returns a true if the errors map doesn't contain any entries
...
// Check adds an error message to the map only if the calidation check is not 'ok'.
